  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto bg-black bg-opacity-50 p-6 sm:p-8 rounded-lg shadow-lg">
        ...
        <p className="text-white text-base sm:text-lg leading-relax mb-6">
        ...
        <p className="text-blue-400 text-base sm:text-lg leading-relax text-center font-extrabold mt-10">
